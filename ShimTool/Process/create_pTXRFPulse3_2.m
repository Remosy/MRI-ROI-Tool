function create_pTXRFPulse3_2( afGradient, afRFPulse, dopt)
%% ------------- CONFIGURATION ----------------
...
%% ------------------ WRITE FILE ---------------------
strFileName = sprintf('../OutPut/%s.ini', dopt.fileName);
%fullMatFileName  = fullfile('../OutPut/', strFileName);
fid = fopen( strFileName, 'w');

% header at start
fprintf(fid, '#pTXRFPulse\n', FCTNAME, VERSION);
